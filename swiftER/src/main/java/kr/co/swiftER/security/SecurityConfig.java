...
public class SecurityConfig {
	...
	protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests()
				...
				.requestMatchers("/community/freeList").hasAnyRole("0", "1", "2")
				.requestMatchers(new AntPathRequestMatcher("/community/freeView", "GET")).permitAll()
		        .requestMatchers(new AntPathRequestMatcher("/community/freeView", "POST")).permitAll()
				...
				.requestMatchers("community/modifyComment").hasAnyRole("2")
				.requestMatchers("/community/qnaComment").hasRole("2")
